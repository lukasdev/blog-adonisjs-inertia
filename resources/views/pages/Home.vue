...
<template>
    ...
    <ul class="tw-grid tw-grid-cols-2 md:tw-grid-cols-4 tw-gap-4">
        <li class="tw-bg-white tw-rounded-lg tw-overflow-hidden tw-shadow-md" v-for="n in 8">
            ...
            <div class="tw-p-4">
                <h3 class="tw-font-bold tw-text-lg tw-mb-2">Titulo do Artigo 1</h3>
                <p class="tw-text-gray-700 tw-mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit...</p>
                <a href="#" class="tw-block tw-bg-blue-500 tw-text-white tw-px-4 tw-py-2 
                tw-rounded hover:tw-bg-blue-600 tw-text-center">Ler Mais</a>
            </div>
        </li>
    </ul>
</template>